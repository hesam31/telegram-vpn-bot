...
# ====== EXTENDED MODULES: PURCHASE FLOW, REFERRAL, SERVER POOL ======

# ----- Utility Block 0 -----
def util_block_0_log(user_id, action, meta=None):
    """Extended logging helper 0"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_0 error: {e}")

def util_block_0_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 1 -----
def util_block_1_log(user_id, action, meta=None):
    """Extended logging helper 1"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_1 error: {e}")

def util_block_1_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 2 -----
def util_block_2_log(user_id, action, meta=None):
    """Extended logging helper 2"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_2 error: {e}")

def util_block_2_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 3 -----
def util_block_3_log(user_id, action, meta=None):
    """Extended logging helper 3"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_3 error: {e}")

def util_block_3_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 4 -----
def util_block_4_log(user_id, action, meta=None):
    """Extended logging helper 4"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_4 error: {e}")

def util_block_4_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 5 -----
def util_block_5_log(user_id, action, meta=None):
    """Extended logging helper 5"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_5 error: {e}")

def util_block_5_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 6 -----
def util_block_6_log(user_id, action, meta=None):
    """Extended logging helper 6"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_6 error: {e}")

def util_block_6_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 7 -----
def util_block_7_log(user_id, action, meta=None):
    """Extended logging helper 7"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_7 error: {e}")

def util_block_7_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 8 -----
def util_block_8_log(user_id, action, meta=None):
    """Extended logging helper 8"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_8 error: {e}")

def util_block_8_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 9 -----
def util_block_9_log(user_id, action, meta=None):
    """Extended logging helper 9"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_9 error: {e}")

def util_block_9_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 10 -----
def util_block_10_log(user_id, action, meta=None):
    """Extended logging helper 10"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_10 error: {e}")

def util_block_10_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 11 -----
def util_block_11_log(user_id, action, meta=None):
    """Extended logging helper 11"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_11 error: {e}")

def util_block_11_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 12 -----
def util_block_12_log(user_id, action, meta=None):
    """Extended logging helper 12"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_12 error: {e}")

def util_block_12_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 13 -----
def util_block_13_log(user_id, action, meta=None):
    """Extended logging helper 13"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_13 error: {e}")

def util_block_13_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 14 -----
def util_block_14_log(user_id, action, meta=None):
    """Extended logging helper 14"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_14 error: {e}")

def util_block_14_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 15 -----
def util_block_15_log(user_id, action, meta=None):
    """Extended logging helper 15"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_15 error: {e}")

def util_block_15_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 16 -----
def util_block_16_log(user_id, action, meta=None):
    """Extended logging helper 16"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_16 error: {e}")

def util_block_16_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 17 -----
def util_block_17_log(user_id, action, meta=None):
    """Extended logging helper 17"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_17 error: {e}")

def util_block_17_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 18 -----
def util_block_18_log(user_id, action, meta=None):
    """Extended logging helper 18"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_18 error: {e}")

def util_block_18_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 19 -----
def util_block_19_log(user_id, action, meta=None):
    """Extended logging helper 19"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_19 error: {e}")

def util_block_19_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 20 -----
def util_block_20_log(user_id, action, meta=None):
    """Extended logging helper 20"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_20 error: {e}")

def util_block_20_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 21 -----
def util_block_21_log(user_id, action, meta=None):
    """Extended logging helper 21"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_21 error: {e}")

def util_block_21_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 22 -----
def util_block_22_log(user_id, action, meta=None):
    """Extended logging helper 22"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_22 error: {e}")

def util_block_22_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 23 -----
def util_block_23_log(user_id, action, meta=None):
    """Extended logging helper 23"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_23 error: {e}")

def util_block_23_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 24 -----
def util_block_24_log(user_id, action, meta=None):
    """Extended logging helper 24"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_24 error: {e}")

def util_block_24_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 25 -----
def util_block_25_log(user_id, action, meta=None):
    """Extended logging helper 25"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_25 error: {e}")

def util_block_25_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 26 -----
def util_block_26_log(user_id, action, meta=None):
    """Extended logging helper 26"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_26 error: {e}")

def util_block_26_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 27 -----
def util_block_27_log(user_id, action, meta=None):
    """Extended logging helper 27"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_27 error: {e}")

def util_block_27_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 28 -----
def util_block_28_log(user_id, action, meta=None):
    """Extended logging helper 28"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_28 error: {e}")

def util_block_28_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 29 -----
def util_block_29_log(user_id, action, meta=None):
    """Extended logging helper 29"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_29 error: {e}")

def util_block_29_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 30 -----
def util_block_30_log(user_id, action, meta=None):
    """Extended logging helper 30"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_30 error: {e}")

def util_block_30_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 31 -----
def util_block_31_log(user_id, action, meta=None):
    """Extended logging helper 31"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_31 error: {e}")

def util_block_31_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 32 -----
def util_block_32_log(user_id, action, meta=None):
    """Extended logging helper 32"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_32 error: {e}")

def util_block_32_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 33 -----
def util_block_33_log(user_id, action, meta=None):
    """Extended logging helper 33"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_33 error: {e}")

def util_block_33_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 34 -----
def util_block_34_log(user_id, action, meta=None):
    """Extended logging helper 34"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_34 error: {e}")

def util_block_34_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 35 -----
def util_block_35_log(user_id, action, meta=None):
    """Extended logging helper 35"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_35 error: {e}")

def util_block_35_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 36 -----
def util_block_36_log(user_id, action, meta=None):
    """Extended logging helper 36"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_36 error: {e}")

def util_block_36_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 37 -----
def util_block_37_log(user_id, action, meta=None):
    """Extended logging helper 37"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_37 error: {e}")

def util_block_37_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 38 -----
def util_block_38_log(user_id, action, meta=None):
    """Extended logging helper 38"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_38 error: {e}")

def util_block_38_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r


# ----- Utility Block 39 -----
def util_block_39_log(user_id, action, meta=None):
    """Extended logging helper 39"""
    try:
        db = load_db()
        if "logs" not in db:
            db["logs"] = []
        ...
        logging.error(f"util_block_39 error: {e}")

def util_block_39_rand_price(base):
    r = random.randint(1000,9000)
    return int(base) + r
...
def get_server_pool():
    db = load_db()
    if "server_pool" not in db:
        db["server_pool"] = []
    return db["server_pool"]

def add_server_to_pool(config_text):
    db = load_db()
    if "server_pool" not in db:
        db["server_pool"] = []
    db["server_pool"].append({
        "config": config_text,
        "used": False,
...
def register_referral(inviter, user_id):
    db = load_db()
    users = db.setdefault("users", {})
    inv = users.setdefault(str(inviter), {})
    refs = inv.setdefault("referrals", [])
...
def referral_count(user_id):
    ...
    return len(u.get("referrals", []))

def referral_reward_available(user_id):
    return referral_count(user_id) >= REFERRAL_TARGET

# ===== RECEIPT STORAGE =====

def store_receipt(user_id, file_id, plan):
    db = load_db()
...
def pending_receipts():
    db = load_db()
    return [r for r in db.get("receipts",[]) if r["status"]=="pending"]

def approve_receipt(index):
    db = load_db()
    r = db["receipts"][index]
    r["status"]="approved"
    save_db(db)
